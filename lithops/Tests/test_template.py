...
# import lithops # required to use function executor's functions, e.g. map().
# from lithops.tests import main_util  # required to initialize config variables and other constants below.
# from lithops.tests.util_func.map_util import simple_map_function  # required to use map_util's ready to use functions.
...
# class TestFeatureName(unittest.TestCase):  # Mandatory,unittest test classes are in camel format and inherit as demonstrated.
    ...
    #def test_tester_name(self):  # unittest's function naming convention requires functions to be named as demonstrated.
        ...
        # fexec.map(simple_map_function,[(1, 1), (2, 2), (3, 3), (4, 4)])
