...
|vm | extra_apt_packages | [] | no | Extra Debian/Ubuntu packages installed during Lithops setup on the VM. List or space-separated string. See [VM installation extras](../execution_modes.rst#vm-installation-extras) |
|vm | extra_python_packages | [] | no | Extra pip packages installed after Lithops on the VM. List or space-separated string. See [VM installation extras](../execution_modes.rst#vm-installation-extras) |
