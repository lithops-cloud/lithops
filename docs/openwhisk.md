...
Lithops can also run on vanilla OpenWhisk installations, for example by deploying OpenWhisk with [openwhisk-devtools](https://github.com/apache/openwhisk-devtools).
...
If everything is working fine, you can proceed to configure Lithops. To do so, edit *~/.lithops_config* and add the next section::
...
if __name__ == '__main__':
    wsk = lithops.openwhisk_executor()
