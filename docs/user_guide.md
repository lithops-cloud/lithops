...
2. [Supported Clouds](source/supported_clouds.rst)
...
4. [Execution Modes](source/execution_modes.rst)

5. [Functions design and parameters](source/functions.md)
...
6. [Distributed shared objects across function activations](source/dso.rst)

7. [Distributed Scikit-learn / Joblib](source/sklearn_joblib.rst)

8. [Lithops for big data analytics](source/data_processing.rst)
...
13. [Command Line Tool](source/cli.rst)