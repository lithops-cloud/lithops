...
virt-customize -a ubuntu-20.04-server-cloudimg-amd64.img  --run-command 'pip3 install flask gevent pika==0.13.1 cloudpickle tblib ps-mem ibm-vpc namegenerator  ibm-cos-sdk requests paramiko python-dateutil>> /tmp/lithops/proxy.log'
